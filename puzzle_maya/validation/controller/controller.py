...
from PySide2.QtWidgets import QWidget, QVBoxLayout, QSizePolicy, QPushButton, QFileDialog, QStyleFactory, QMessageBox
...
class AddonsWindow(QtWidgets.QMainWindow, addons_uiFile.Ui_MainWindow, mainUI):
	def __init__(self, parent):
		super(AddonsWindow, self).__init__(parent)
...
class ItemCheckWindow(QtWidgets.QMainWindow, itemCheck_uiFile.Ui_MainWindow, mainUI):
	def __init__(self, file, parent):
		super(ItemCheckWindow, self).__init__(parent)
