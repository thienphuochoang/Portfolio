...
maxMainWindow = GetQMaxMainWindow()  # get Max Main Window
...
fm = import_file(r"puzzle_max.validation.function.validate_function")
iconPath = rootDirectory + "/" + "lib" + "/" + "icon"
presetPath = rootDirectory + "/" + "puzzle_max" + "/" + "validation" + "/" + "preset"
collapsiblePath = rootDirectory + "/" + "puzzle_max" + "/" + "validation" + "/" + "function"
		...
		for projectName in os.listdir(collapsiblePath):
			if os.path.isdir(collapsiblePath + "/" + projectName) == False:
				...
				for i in os.listdir(collapsiblePath + "/" + projectName):
					functionPath = collapsiblePath + "/" + projectName
					try:
						f = import_file("puzzle_max.validation.function" + "." + projectName + "." + file.split(".")[0])
...
class MainValidationWindow(QtWidgets.QMainWindow, ui_file.Ui_MainWindowValidation):
	def __init__(self):
		super(MainValidationWindow, self).__init__(parent=maxMainWindow)
		#Load UI
		self.setupUi(self)
